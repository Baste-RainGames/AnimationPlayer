...
/// https://issuetracker.unity3d.com/issues/serialization-system-dot-guid-can-not-be-serialized // @TODO it is not marked as fixed!
/// </summary>
[Serializable]
...
{
    public static SerializedGUID Empty => new()  { guid = Guid.Empty };
