...
public class SingleClipEditor : AnimationStateEditor
{
    ...
    public override AnimationPlayerState CreateNewState(int stateIndex) => SingleClip.Create($"State {stateIndex}");

    public override void GenerateUI()
    {
        var path = "Packages/com.baste.animationplayer/Editor/UI/StateEditors/SingleClipEditor.uxml";
