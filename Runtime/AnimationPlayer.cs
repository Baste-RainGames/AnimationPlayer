...
public class AnimationPlayer : MonoBehaviour, IAnimationClipSource
{
    ...
    [SerializeField] internal List<ClipSwapCollection> clipSwapCollections = new();
    ...
    private Dictionary<string, float> blendVariableValues = new ();
    private List<string> blendVariablesUpdatedThisFrame = new ();
    ...
    /// <summary>
    /// Gets the currently playing state. If you call Play(state), this will immediately return 'state', even though the weight of that state is still 0.
    /// </summary>
    ...
    private readonly List<AnimationClip> allClipsInPlayer = new ();
